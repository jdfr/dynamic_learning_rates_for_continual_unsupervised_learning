function [Model] = TrainGHNF(Samples,Epochs,MaxNeurons,Tau,Lambda,EpsilonB,EpsilonN,Alpha,AMax,D,Level)
% Train a Growing Hierarchical Neural Forest (GHNF)
% E.J. Palomo  -- Last Modified: Ausgust 2015
% Inputs:
...
Model = TrainGNFHierarchicalVersion(Samples,MaxNeurons,Lambda,EpsilonB,EpsilonN,Alpha,AMax,D,NumSteps,Tau);
...
for NdxNeuro=NdxNeurons
    ...
    Model.Child{NdxNeuro} = TrainGHNF(ChildSamples,Epochs,...
