function PerformanceMeasures = TestGHNFSegmentation(Model,TrainingWinners,TrainingErrors,ColorSpaceName,VideoName,NumFrames,NumGTFrames,DeltaFrames,VideoPath,GTPath,Mu,Features,WindowSizeRGBMedian,MaxNeurons,Beta)
...
%         [TestWinners,TestErrors] = TestGHNF(GetCentroidsGHNF(Model),TestSamples);
        % Test GHNG
        [TestWinners,TestErrors] = TestGHNG(GetCentroidsGHNG(Model),TestSamples);
