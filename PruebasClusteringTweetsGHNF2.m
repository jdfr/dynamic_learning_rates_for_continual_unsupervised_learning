% Pruebas Clustering de Tweets para el GHNF 2
clear all
...
% Load LSI Samples
if exist([PathData 'SamplesLSI.mat'],'file')
    fprintf('\tLSI samples already obtained\n');
    load([PathData 'SamplesLSI.mat'],'SamplesLSI','U');
else
    fprintf('\tObtaining samples from tweet dataset...\n');
    
    % Perform a tf-idf weighting
    Samples = tfidf(Samples);

    % Data normalization in (0,1)
