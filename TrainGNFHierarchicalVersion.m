function [Model]=TrainGNFHierarchicalVersion(Samples,MaxUnits,Lambda,EpsilonB,EpsilonN,Alpha,AMax,D,NumSteps,Tau)
% Train a modified Growing Neural Forest (GNF) neural network.
...
% Output:
%   Model=Trained modified GNF model
